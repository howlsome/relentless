...
This is the build-ready PRD split into seven build stages plus a shared context file and a second-pass refactor stage. Load files in pairs: always include `00-shared-context.md`, then the stage you are currently on.
...
| 3 | Fetch script | `03-fetch-script.md` | 00, 02 | WCL and Raider.io fetch, batching, rate limits, changelog generation. |
...
| 7 | Second-pass refactor | `07-second-pass-refactor.md` | 00, plus relevant earlier stages | Biome, TypeScript, composable components, progressive enhancement, lockout detection with exemptions. |
| 8 | Heroic advisory & multi-spec | `08-heroic-advisory-and-multispec.md` | 00, 07 | Heroic-vs-Mythic severity distinction, repeatable-behaviour escalation, multi-spec raider support. |

Stages 0–6 build the first-pass implementation. Stages 7 and 8 are refinements applied on a refactor branch after the first pass is live.
